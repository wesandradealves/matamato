    ...
    <div class="container">
        ...
        <div class="d-flex flex-column flex-md-row  ">
            ...
            <div data-type="outlined"
                ...
                <img class="d-block" src="<?php echo get_template_directory_uri(); ?>/img/a-revolucao-a-vapor-jet-vap.jpg"
                ...
                <svg class="outline" xmlns="http://www.w3.org/2000/svg" width="278" height="278" viewBox="0 0 278 278">
                    <g fill="none" stroke="#307dcb" stroke-width="1">
                        <path
                            d="M0,0H158A120,120,0,0,1,278,120V278a0,0,0,0,1,0,0H120A120,120,0,0,1,0,158V0A0,0,0,0,1,0,0Z"
                            stroke="none" />
                        <path
                            d="M.5.5H158A119.5,119.5,0,0,1,277.5,120V277.5a0,0,0,0,1,0,0H120A119.5,119.5,0,0,1,.5,158V.5A0,0,0,0,1,.5.5Z"
                            fill="none" />
                    </g>
                </svg>
            </div>
...
<section id="tecnologia-por-uma-cidade-mais-sustentavel" class="tecnologia-por-uma-cidade-mais-sustentavel">
    <div class="container">
        <div class="d-block mb-5 pb-4 col-12 col-md-7">
            ...
            <p class="text ">Veja como a Jet Vap Mata Mato 300 é a mais eficiente e econômica solução para a capina
                urbana do seu município:</p>
        </div>
        <ul class="table d-block">
            <li class="table-header">
                <ul class="table-header--content d-flex flex-wrap align-items-stretch justify-content-between">
                    ...
                    <li
                        ...
                        <span class="pt-2 pb-2">Capina Manual</span></li>
                    <li
                        class="table-content--content-row--item d-flex flex-wrap flex-column justify-content-center align-items-center ps-4 pe-4 pb-3 pt-3 col-6 col-md-4">
                        <span class="pt-2 pb-2">Capina a vapor com mata mato urban 300</span></li>
                </ul>
            </li>
            <li class="table-content">
                <ul class="table-content--content">
    ...
    <div class="metodo-testado-e-aprovado">
        <div class="container">
            <h2 class="title mb-5">Um método testado e aprovado.<br />Confira como funciona.</h2>
            <div class="d-flex flex-wrap">
                ...
                <div class="col-12 col-md-6 ps-md-5 mt-5 mt-md-0">
                    <a href="https://www.youtube.com/watch?v=GnMQ53hPF0w" class="d-block glightbox">
...
<section class="testimonials container pt-5">
    <div class="container">
        <svg class="quotation-marks" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 88.9 77.69">
            <defs>
                <style>
                    .cls-1 {
                        fill: #eb9c0a;
            ...
            <path class="cls-1"
                d="m42.18,8.1c-13.82,6.91-18.59,17.87-18.83,34.56h13.59v35.03H0v-30.74C0,23.83,9.06,5.48,38.85,0l3.34,8.1Zm46.71,0c-13.82,6.91-18.59,17.87-18.83,34.56h13.59v35.03h-36.94v-30.74c0-23.12,9.06-41.47,38.85-46.95l3.34,8.1Z" />
        </svg>
        <div class="owl-carousel owl-theme">
            <div class="item d-block">
                <div class="d-block item-inner">
                    <h3 class="testimonials-title mb-4">
                        Thiago Superti
                        <span class="d-block">
                            Comissário de Bordo<br />(morador de Indaiatuba)
                        </span>
                    </h3>
    ...
    <div class="container">
        ...
        <ul class="list d-flex flex-wrap justify-content-between align-items stretch">
            <li class="list-item mb-5 pb-5 d-flex col-6 col-lg-3 flex-column align-items-center">
                <img class="list-item-icon" height="100" src="<?php echo get_template_directory_uri(); ?>/img/icone-capina-100-a-vapor-jet-vap.svg"
            ...
            <li class="list-item mb-5 pb-5 d-flex col-6 col-lg-3 flex-column align-items-center">
                <img class="list-item-icon" height="100" src="<?php echo get_template_directory_uri(); ?>/img/icone-otimizacao-dos-servicos-jet-vap.svg"
            ...
            <li class="list-item mb-5 d-flex col-6 col-lg-3 flex-column align-items-center">
                <img class="list-item-icon" height="100" src="<?php echo get_template_directory_uri(); ?>/img/icone-profissinais-qualificados-jet-vap.svg"
                    alt="Profissionais Qualificados">
                <h3 class="list-item-title mt-5 ps-md-5 pe-md-5">Profissionais Qualificados</h3>
            </li>
            <li class="list-item mb-5 d-flex col-6 col-lg-3 flex-column align-items-center">
                <img class="list-item-icon" height="100" src="<?php echo get_template_directory_uri(); ?>/img/icone-maior-valor-agregado-jet-vap.svg"
                    alt="Maior valor agregado">
                <h3 class="list-item-title mt-5 ps-md-5 pe-md-5">Maior valor agregado</h3>
            </li>
            <li class="list-item mb-5 d-flex col-6 col-lg-3 flex-column align-items-center">
                <img class="list-item-icon" height="100" src="<?php echo get_template_directory_uri(); ?>/img/icone-mais-reputacao-para-sua-marca-jet-vap.svg"
            ...
            <li class="list-item d-flex col-6 col-lg-3 flex-column align-items-center">
                <img class="list-item-icon" height="100" src="<?php echo get_template_directory_uri(); ?>/img/icone-melhor-custo-beneficio-jet-vap.svg"
...
<section id="solucao-em-duas-versoes" class="solucao-em-duas-versoes">
    <div class="container">
        ...
        <ul class="list mt-5 pt-4 d-flex align-items-stretch justify-content-between flex-wrap">
            ...
            <li class="list-item col-12 col-lg-5 d-flex flex-column justify-content-between">
                ...
                <div data-type="outlined" class="--centered d-flex flex-column justify-content-end align-items-center">
                    <img class="d-block" src="<?php echo get_template_directory_uri(); ?>/img/solucoes-versao-completa-jet-vap.png"
                ...
                <ul class="list">
                    <li class="list-item ps-5 pe-5 p-md-0 mb-5">
                        ...
                        <p class="mt-3 list-item-text">
                            Presente em todos os estados brasileiros e vários países da América Latina, África e Europa.
                        </p>
                    </li>
                    <li class="list-item ps-5 pe-5 p-md-0 mb-5">
